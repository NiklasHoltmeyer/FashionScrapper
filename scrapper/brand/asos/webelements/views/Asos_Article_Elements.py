...
from utils.list import distinct_list_of_dicts, flatten
from utils.web.dynamic import wait, scroll_end_of_page
...
class Asos_Article_Elements:
    ...
    @staticmethod
    def _parse_item(product_doc, doc_might_like, product_container_id):
        def _parse_img(img):
            return {
                "url": img["src"].split("?")[0],
                "url_full": img["src"],
