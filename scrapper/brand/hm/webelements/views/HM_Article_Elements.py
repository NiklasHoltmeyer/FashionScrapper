...
from utils.web.dynamic import scroll_end_of_page
from utils.web.dynamic import wait
from utils.web.static import find_first_parent_href
...
class HM_Article_Elements:
    ...
    @staticmethod
    def _parse_item(product_doc, doc_might_like):
